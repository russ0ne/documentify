...
<s:layout-render name="/WEB-INF/jsp/common/layout_menu.jsp"
	...
	<s:layout-component name="body">
		...
		<p></p>
		<d:table name="${actionBean.users}" id="aUser" requestURI=""
			defaultsort="1">
			...
			<d:column title="Actions">
                ...
                <s:link
					beanclass="documentify.action.UserFormActionBean">
					<s:param name="user" value="${aUser}" />Update
                </s:link> |
                <s:link
					beanclass="documentify.action.UserListActionBean" event="delete"
					onclick="return confirm('Delete user ID = ${aUser}?');">
