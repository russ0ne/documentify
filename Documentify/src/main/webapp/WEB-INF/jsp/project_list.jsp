...
<s:layout-render name="/WEB-INF/jsp/common/layout_menu.jsp"
	...
	<s:layout-component name="body">
		...
		<p></p>
		<d:table name="${actionBean.projects}" id="aProject" requestURI=""
			defaultsort="1">
			...
			<d:column title="Actions">
                ...
                <s:link
					beanclass="documentify.action.ProjectFormActionBean">
					<s:param name="project" value="${aProject}" />Update
                </s:link> |
                <s:link
					beanclass="documentify.action.ProjectListActionBean" event="delete"
					onclick="return confirm('Delete project ID = ${aProject}?');">
