			...
			<table class="form">
				...
				<tr>
					...
					<td><s:select name="request.project">
							...
							<s:options-collection collection="${projects.projects}"
								value="id" label="projectName" />
						</s:select></td>
					<td><s:errors field="request.project" /></td>
				</tr>
				<tr>
					<td><s:label for="request.dateOfRequest">:</s:label></td>
					<td><s:text name="request.dateOfRequest"
							formatPattern="dd/MM/yyyy" /></td>
					<td><s:errors field="request.dateOfRequest" /></td>
				</tr>
				<tr>
					<td><s:label for="request.reviewDate">:</s:label></td>
					<td><s:text name="request.reviewDate"
							formatPattern="dd/MM/yyyy" /></td>
				...
				<tr>
					...
					<td><s:select name="request.assignedPriority">
							<%--<s:option value="">Select a project...</s:option>--%>
							<s:options-enumeration enum="documentify.model.Priority"
								label="priority" />
						</s:select></td>
				...
				<tr>
					...
					<td><s:select name="request.status">
							<s:options-enumeration enum="documentify.model.Status"
								label="status" />
						</s:select></td>
				...
				<tr>
					...
					<td><s:select name="request.requester">
							<s:options-collection collection="${users.users}" value="id"
								label="userName" />
						</s:select></td>
